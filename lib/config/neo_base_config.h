#ifndef NEO_BASE_CONFIG_H
#define NEO_BASE_CONFIG_H
...
#define K_P 2.8 // P constant
#define K_I 0.0001 // I constant
#define K_D 0.4 // D constant

//define your robot' specs here
#define MAX_RPM 210              // motor's maximum RPM
#define COUNTS_PER_REV 2960      // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.1687    // wheel's diameter in meters
#define PWM_BITS 8              // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.185 // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.0   //0.30  // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
